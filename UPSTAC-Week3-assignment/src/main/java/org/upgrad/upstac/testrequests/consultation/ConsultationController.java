...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        return testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED); //getting list of test requests having status as 'LAB_TEST_COMPLETED'
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        return testRequestQueryService.findByDoctor(loggedInDoctor);  // getting all test requests assigned to current doctor
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            User doctor = userLoggedInService.getLoggedInUser(); // getting currently logged in doctor
            TestRequest result = testRequestUpdateService.assignForConsultation(id,doctor); // assigning given test request(id) to the given doctor
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            User doctor = userLoggedInService.getLoggedInUser(); // getting logged in user
            TestRequest result = testRequestUpdateService.updateConsultation(id,testResult,doctor); // updating the current test requests(id) with the testResult details by the current user
