...
class LabRequestControllerTest {
    ...
    public void calling_assignForLabTest_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest updatedTestRequest = labRequestController.assignForLabTest(testRequest.getRequestId()); //created another object of TestRequest method

        assertThat(updatedTestRequest.getRequestId(),equalTo(testRequest.getRequestId())); // request ids of both the objects created is same
        assertThat(updatedTestRequest.getStatus(),equalTo(RequestStatus.LAB_TEST_IN_PROGRESS)); //status of the second object is equal to 'LAB_TEST_IN_PROGRESS'

        assertNotNull(updatedTestRequest.getLabResult());  // making sure that lab result of second object is not null
    ...
    public void calling_updateLabTest_with_invalid_test_request_id_should_throw_exception(){
        ...
        ResponseStatusException exception = assertThrows(ResponseStatusException.class,()->{
            labRequestController.updateLabTest(-84L,createLabResult);
        });
    ...
    public CreateLabResult getCreateLabResult(TestRequest testRequest) {
        ...
        createLabResult.setBloodPressure("1110/90");
        ...
        createLabResult.setComments("looks Alright");
